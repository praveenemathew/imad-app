...
var articles = {
 'article-one':{
    title:"Article-one | Praveen E Mathew",
    heading:"Article one",
    date:"sep 28 2017",
    content:`<p>
            This is the content for the first article .This is the content for the first article .This is the content for the first article .
            This is the content for the first article .This is the content for the first article .This is the content for the first article .
            This is the content for the first article .This is the content for the first article .This is the content for the first article .
        </p>
        <p>
...
app.get('/ui/56.js', function (req, res) {
  res.sendFile(path.join(__dirname, 'ui', '56.js'));
});
